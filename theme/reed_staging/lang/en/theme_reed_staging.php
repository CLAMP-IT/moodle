...
/**
 * Strings for component 'theme_reed_staging', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package    theme
 * @subpackage reed_staging
 * @copyright  2011 Julian Ridden
 * @copyright  2012 Lafayette College ITS
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */

$string['pluginname'] = 'Reed Staging';
...
<h2>About</h2>
<p>Reed_Staging is a derivative of the Rocket theme, whose description follows below. Lafayette College tweaked it to suit various institutional needs.</p>
...
$string['configtitle'] = 'reed_staging theme';
