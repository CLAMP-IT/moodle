...
/**
 * Strings for component 'enrol_manual', language 'en_us', branch 'MOODLE_20_STABLE'
 *
...
$string['defaultperiod_desc'] = 'Default length of time that the enrollment is valid (in seconds). If set to zero, the enrollment duration will be unlimited by default.';
