...
class tinymce_texteditor extends texteditor {
    ...
    protected function get_init_params($elementid, array $options=null) {
        ...
        $params = array(
                    ...
                    'entity_encoding' => "raw",
                    'plugins' => "{$xmedia}advimage,safari,table,style,layer,advhr,advlink,emotions,inlinepopups,searchreplace,paste,directionality,fullscreen,{$xemoticon}{$xdragmath}nonbreaking,contextmenu,insertdatetime,save,iespell,preview,print,noneditable,visualchars,xhtmlxtras,template,pagebreak,spellchecker",
                    'theme_advanced_font_sizes' => "1,2,3,4,5,6,7",
                    'theme_advanced_layout_manager' => "SimpleLayout",
                    'theme_advanced_toolbar_align' => "left",
		    'theme_advanced_buttons1' => "fullscreen,|,selectall,cut,copy,paste,pastetext,pasteword,|,justifyleft,justifycenter,justifyright,justifyfull,|,link,unlink,anchor,|,ltr,rtl,|,spellchecker",
		    'theme_advanced_buttons2' => "bold,italic,underline,strikethrough,sub,sup,|,table,hr,bullist,numlist,outdent,indent,|,|,code,|,undo,redo",
		    'theme_advanced_buttons3' => "fontselect,fontsizeselect,formatselect,|,forecolor,backcolor,|,nonbreaking,charmap,image,{$xmedia}",
