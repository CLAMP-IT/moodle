# [Moodle Liberal Arts Edition v4.5.14-LAE27.0.12]
...
Moodle 4.5.14+LAE27.0.12 consists of the core Moodle 4.5.14 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v4.5.14-LAE27.0.12
    git checkout -b v4.5.14-LAE27.0.12

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v4.5.14-LAE27.0.12-base tag instead.
