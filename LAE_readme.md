# [Moodle Liberal Arts Edition v4.1.15-LAE23.0.15]
...
Moodle 4.1.15+LAE23.0.15 consists of the core Moodle 4.1.15 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v4.1.15-LAE23.0.15
    git checkout -b v4.1.15-LAE23.0.15

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v4.1.15-LAE23.0.15-base tag instead.
