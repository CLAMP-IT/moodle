# [Moodle Liberal Arts Edition v5.2.2-LAE30.0.1]
...
Moodle 5.2.2+LAE30.0.1 consists of the core Moodle 5.2.2 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v5.2.2-LAE30.0.1
    git checkout -b v5.2.2-LAE30.0.1

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v5.2.2-LAE30.0.1-base tag instead.
