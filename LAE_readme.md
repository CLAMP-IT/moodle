# [Moodle Liberal Arts Edition v5.0.6-LAE28.0.4]
...
Moodle 5.0.6+LAE28.0.4 consists of the core Moodle 5.0.6 release plus a number of CLAMP-developed features and bug fixes.
...
* Download the current release branch from the CLAMP code repository:
    ...
    git clone https://github.com/CLAMP-IT/moodle v5.0.6-LAE28.0.4
    git checkout -b v5.0.6-LAE28.0.4

By default this is the "Package" version which includes the contributed modules. If you just want the core version of the LAE checkout the v5.0.6-LAE28.0.4-base tag instead.
